...
ALTER TABLE `action` 
CHANGE COLUMN `type` `type` ENUM('output', 'redirect', 'popup', 'call', 'webapi', 'emit', 'mutation', 'closepopup', 'interval', 'validate') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NOT NULL DEFAULT 'output' ;
...
CHANGE COLUMN `type` `type` ENUM('output', 'redirect', 'popup', 'call', 'webapi', 'emit', 'mutation', 'closepopup', 'interval', 'validate', 'break') CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NOT NULL DEFAULT 'output' ;
