 ...
 * @package project
 */
class Module_Model extends YZE_Model{
    use Module_Model_Method;
    
    const TABLE= "module";
    const VERSION = 'modified_on';
    const MODULE_NAME = "project";
    const KEY_NAME = "id";
    const CLASS_NAME = 'app\project\Module_Model';
    /**
    ...
    'id'         => ['type' => 'integer', 'null' => false,'length' => '11','default'	=> ''],
      ...
      'folder'     => ['type' => 'string', 'null' => true,'length' => '45','default'	=> ''],
    ];
    /**
  ...
  'id' => 'PRIMARY',
  'project_id' => 'fk_module_project_idx',
);
    ...
    public function get_column_mean($column){
		...
		case self::F_FOLDER: return "模块存储目录名";
