 ...
 * @package project
 */
class Style_Model extends YZE_Model{
    use Style_Model_Method;
    
    const TABLE= "style";
    const VERSION = 'modified_on';
    const MODULE_NAME = "project";
    const KEY_NAME = "id";
    const CLASS_NAME = 'app\project\Style_Model';
    /**
    ...
    'id'         => ['type' => 'integer', 'null' => false,'length' => '','default'	=> ''],
      ...
      'class_name' => ['type' => 'string', 'null' => true,'length' => '45','default'	=> ''],
      'meta'       => ['type' => 'string', 'null' => true,'length' => '','default'	=> ''],
  ...
  'id' => 'PRIMARY',
  'project_id' => 'fk_style_project1_idx',
);
    ...
    public function get_column_mean($column){
		...
		case self::F_CLASS_NAME: return "class_name";
		case self::F_META: return "meta";
