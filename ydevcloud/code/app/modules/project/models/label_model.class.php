 ...
 * @package project
 */
class Label_Model extends YZE_Model{
    use Label_Model_Method;
    
    const TABLE= "label";
    const VERSION = 'modified_on';
    const MODULE_NAME = "project";
    const KEY_NAME = "id";
    const CLASS_NAME = 'app\project\Label_Model';
    /**
     ...
     * @var string
     */
    const F_PINYIN_SORT = "pinyin_sort";
    /**
     * 
     * @var integer
     */
    ...
    'id'         => ['type' => 'integer', 'null' => false,'length' => '','default'	=> ''],
      ...
      'pinyin'     => ['type' => 'string', 'null' => true,'length' => '200','default'	=> ''],
      'pinyin_sort' => ['type' => 'string', 'null' => true,'length' => '45','default'	=> ''],
  ...
  'id' => 'PRIMARY',
  'project_id' => 'fk_label_project1_idx',
);
    ...
    public function get_column_mean($column){
		...
		case self::F_NAME: return "标签名";
		case self::F_PINYIN: return "pinyin";
		case self::F_PINYIN_SORT: return "pinyin_sort";
