...
* @package project
*/
class Func_Controller extends YZE_Resource_Controller {
    ...
    public function index(){
        ...
        $breadcrumbs['/project/'.$project->uuid.'/structure?uuid='.$module->uuid] = $module->name;
        ...
        $this->set_view_data('yze_page_title', __('Module'));
    }
