...
* @package project
*/
class Database_Controller extends YZE_Resource_Controller {
    ...
    public function index(){
        ...
        $this->set_View_Data('menu', 'database');
        $this->set_view_data('yze_page_title', __('Database'));
    }
