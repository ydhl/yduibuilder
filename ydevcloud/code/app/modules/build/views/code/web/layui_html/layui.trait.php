<?php
namespace app\modules\build\views\code\web\layui_html;


use app\build\Build_Model;
/**
 * 由于layui 生成的代码和在线预览一样，所以web前端不同框架代码生成Class都继承之Preview
...
trait Layui {
    public static function get_View_Class(array $uiconfig, Build_Model $build){
        ...
        return "app\\modules\\build\\views\\code\\web\\layui_html\\{$type}_View";
    }
