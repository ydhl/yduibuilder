...
class Rangeinput_View extends Preview_View implements Valuable_View {
    ...
    public function build_ui()
    {
        ...
        if ($inputDataName && !$outputDataName['VALUE']){
            ...
            echo $this->wrap_output(':value', $inputIsArr ? $iteratorDataName : $outputDataName['VALUE']);
        }else{
    ...
    protected function style_map($meta=null, $state = 'normal')
    {
        ...
        $map['padding'] = 'padding: 0px !important'; // 去掉内间距，内间距会导致自定义背景计算宽度时不正确
        return $map;
    }

    protected function output_as_prop($outputAs, $outputData)
    {
        if(strtolower($outputAs) == 'value') return ":value";
