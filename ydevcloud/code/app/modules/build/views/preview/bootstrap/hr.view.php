...
class Hr_View extends Preview_View {
    ...
    public function build_ui()
    {
        ...
        echo ">".PHP_EOL;
        echo $this->indent(1)."<div".$this->wrap_output("style", $this->lineStyle()).$this->wrap_output("class", $this->lineCss())."></div>".PHP_EOL;
        ...
        if ($htmlOutputData || $textOutputData){
            ...
            echo $this->indent(1)."<div".$this->wrap_output("style", $this->textStyle()).$this->wrap_output("class", $this->textCss());
